...
def test_send_api_request_local(
    ...
    # Assert
    get_oracle.fulfillOracleRequest(
...
def test_send_api_request_testnet(deploy_price_exercise, get_link_token, chainlink_fee):
    # Arrange
...
def test_can_get_latest_price(get_oracle, get_job_id, chainlink_fee, get_link_token, get_eth_usd_price_feed_address):
    # Arrange
